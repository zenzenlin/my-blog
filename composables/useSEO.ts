export const useArticleSchema = (article: any) => {
  return {
    ...
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: "https://my-blog-taupe-one.vercel.app/my-blog/logo.svg",
      },
    },
    ...
    image:
      article.image ||
      "https://my-blog-taupe-one.vercel.app/my-blog/og-image.png",
    url: `https://my-blog-taupe-one.vercel.app/my-blog${article._path}`,
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://my-blog-taupe-one.vercel.app/my-blog${article._path}`,
    },
...
export const useBreadcrumbSchema = (
  ...
  return {
    ...
    itemListElement: breadcrumbs.map((crumb, index) => ({
      ...
      position: index + 1,
      name: crumb.name,
      item: `https://my-blog-taupe-one.vercel.app/my-blog${crumb.path}`,
    })),
  };
};
...
export const useWebsiteSchema = () => {
  return {
    ...
    potentialAction: {
      "@type": "SearchAction",
      target:
        "https://my-blog-taupe-one.vercel.app/my-blog/?search={search_term_string}",
